...
-- Applied improved fly implementation (BodyVelocity + BodyGyro, WASD/Space/Shift controls)
-- ============================================
...
local function toggleFly(state)
    ...
    rootPart = char and (char:FindFirstChild("HumanoidRootPart") or char:FindFirstChild("Torso") or char:FindFirstChild("UpperTorso")) or rootPart
...
Players.LocalPlayer.CharacterAdded:Connect(function(newChar)
    ...
    rootPart = newChar:FindFirstChild("HumanoidRootPart") or newChar:FindFirstChild("Torso") or newChar:FindFirstChild("UpperTorso")
    ...
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        ...
        input.Changed:Connect(function()
            if input.UserInputState == Enum.UserInputState.End then
                dragging = false
I will stop here to avoid exceeding message size